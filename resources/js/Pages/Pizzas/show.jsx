...
export default function Show({ pizza }) {
    ...
    return (
        <div className="max-w-3xl py-12 mx-auto">
            <div className="py-8">
                <svg className="w-32 h-32 mx-auto rotate-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div className="mt-4 text-center">
                <p className="text-lg">{pizza.chef} started {pizza.status.toLowerCase()} your order <span className="font-semibold underline">{pizza.last_updated}</span></p>
            </div>
        </div>
    );
}
